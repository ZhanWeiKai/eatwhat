-- ============================================
-- 今天吃什么 - Docker环境数据库初始化脚本
-- ============================================
-- 说明：此脚本仅用于首次初始化，不会删除现有数据

SET NAMES utf8mb4;
SET CHARACTER SET utf8mb4;

-- 使用数据库（由MySQL环境变量自动创建）
USE what2eat;
...
INSERT IGNORE INTO dish (dish_id, name, description, price, category, uploader_id) VALUES
...
INSERT IGNORE INTO push (push_id, pusher_id, pusher_name, dishes, total_amount) VALUES
